...
export default function InquiriesScreen({
  ...
  // =========================================================
  // BULK ORDER / REQUEST QUOTE PREFILL
  // =========================================================
  //
  // ProductDetailScreen sends:
  //
  ...
  // })
  //
  // This automatically opens the New Request tab
  // and fills the appropriate fields.
  // =========================================================

  useEffect(() => {
    const bulkInquiry =
      route?.params?.bulkInquiry;
    ...
    // If there is a 3D design attached,
    // include that information in Additional Details.
    ...
    // Automatically show New Request
    setActiveTab("new");

    // Clear the parameter after processing it
    // so the form doesn't get refilled repeatedly.
  ...
  const handleSubmit = async () => {
    if (!subject.trim()) {
      Alert.alert(
        "Error",
        "Subject / Product Type is required"
      );
    ...
    try {
      ...
      Alert.alert(
        "Success",
        "Your quote inquiry has been submitted!"
      );
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Quoted Price Estimate:
                </Text>

                <Text
                  style={styles.priceVal}
                >
  ...
  if (!user) {
    return (
      ...
      >
        ...
        >
          Log in to request custom
          quotes, bulk printing rates,
          and view your submitted
          specifications.
        </Text>
    ...
    <View style={styles.container}>
      ...
      {activeTab === "list" ? (
        ...
        >
          ...
          >
            Specify your custom
            requirements below. Our
            admin team will review it
            and assign a quoted price.
          </Text>
