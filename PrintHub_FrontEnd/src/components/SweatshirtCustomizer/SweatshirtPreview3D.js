// src/components/SweatshirtCustomizer/SweatshirtPreview3D.js
...
// Only these zones are ever decal/text-printable (neck/hems are color-only,
// matching tshirt's hem behavior - see HEM_ZONE_OPTIONS in TshirtCustomizerPanel).
const PRINTABLE_ZONE_IDS = ["front", "back", "left_sleeve", "right_sleeve"];
...
export default function SweatshirtPreview3D({
  modelPath,
  shirtColor = "#ffffff",
  ...
  // display-only model.scale.x transform as Tshirt/Jersey/Hoodie - no
